...
def extract_pose_direction(input: dict) -> dict:
    output_dict = {}
    for img, landmark_list in input.items():
        output = []
        for landmark_tuple in landmark_list:
            pose_x, pose_y = landmark_tuple
        ...
        # Add list to dictionary with image
        output_dict[img] = output
